        ...
        <div className="grid items-center gap-16 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <SectionTitle
              ...
              intro="Through the Woods is a 25-acre estate of premium villa plots — designed as a sanctuary, not a subdivision. A flagship clubhouse, layered green corridors, and a hundred quiet luxuries gathered behind one address."
            />
