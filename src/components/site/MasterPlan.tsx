...
export function MasterPlan() {
  return (
    <section id="masterplan" className="relative py-32 md:py-40">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        ...
        <motion.div
          ...
          className="mt-16 overflow-hidden rounded-3xl shadow-soft"
        >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
              <div className="grid items-end gap-8 md:grid-cols-3">
                ...
                <div>
                  ...
                  <div className="font-display text-2xl text-mist">BDA · GBA North</div>
                </div>
                <div>
                  <div className="text-[11px] uppercase tracking-[0.3em] text-gold-soft">
                    Plot range
                  </div>
                  <div className="font-display text-2xl text-mist">600 – 4,000+ sqft</div>
                </div>
              </div>
            </div>
          </div>
