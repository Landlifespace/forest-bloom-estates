...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mavallipura — Premium Plotted Development in North Bengaluru | Land & Life Space" },
      { name: "description", content: "Premium villa plots in Mavallipura, North Bengaluru. 29 acres, 100* amenities, 25,000 sqft clubhouse. BDA approved. Pre-launch from ₹6,500/sqft." },
      ...
      { property: "og:description", content: "Premium villa plots in Mavallipura, North Bengaluru. 29 acres, 100* amenities, 25,000 sqft clubhouse. BDA approved. Pre-launch from ₹6,500/sqft." },
      ...
      { name: "twitter:description", content: "Premium villa plots in Mavallipura, North Bengaluru. 29 acres, 100* amenities, 25,000 sqft clubhouse. BDA approved. Pre-launch from ₹6,500/sqft." },
